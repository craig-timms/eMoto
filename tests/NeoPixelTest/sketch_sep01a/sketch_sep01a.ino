...
void loop()
{
    ...
    Serial.println("255 Colors R, G, B, W...");
    // set the colors, 
    // if they don't match in order, you need to use NeoGrbFeature feature
    strip.SetPixelColor(0, RgbwColor(255,0,0,0));
    strip.SetPixelColor(1, RgbwColor(80,0,0,0));
    strip.SetPixelColor(2, RgbwColor(10,0,0,0));
    ...
    Serial.println("100 Colors R, G, B, W...");
    // set the colors, 
    // if they don't match in order, you need to use NeoGrbFeature feature
    strip.SetPixelColor(0, RgbwColor(100,0,0,100));
    strip.SetPixelColor(1, RgbwColor(0,100,0,100));
    strip.SetPixelColor(2, RgbwColor(0,0,0,100));
    strip.SetPixelColor(3, white);
    // the following line demonstrates rgbw color support
    // if the NeoPixels are rgbw types the following line will compile
    // if the NeoPixels are anything else, the following line will give an error
    ...
    Serial.println("50 Colors R, G, B, W...");
    // set the colors, 
    // if they don't match in order, you need to use NeoGrbFeature feature
    strip.SetPixelColor(0, RgbwColor(50,0,0,0));
    strip.SetPixelColor(1, RgbwColor(0,50,0,0));
    strip.SetPixelColor(2, RgbwColor(0,0,0,50));
    strip.SetPixelColor(3, white);
    // the following line demonstrates rgbw color support
    // if the NeoPixels are rgbw types the following line will compile
    // if the NeoPixels are anything else, the following line will give an error
    ...
    Serial.println("10 Colors R, G, B, W...");
    // set the colors, 
    // if they don't match in order, you need to use NeoGrbFeature feature
    strip.SetPixelColor(0, RgbwColor(10,0,0,0));
    strip.SetPixelColor(1, RgbwColor(0,10,0,0));
    strip.SetPixelColor(2, RgbwColor(0,0,0,10));
    strip.SetPixelColor(3, white);
    // the following line demonstrates rgbw color support
    // if the NeoPixels are rgbw types the following line will compile
    // if the NeoPixels are anything else, the following line will give an error
