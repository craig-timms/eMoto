...
void Signals::setup(void)
{
    ...
    FastLED.addLeds<WS2811, GPIO_LED_BACK, GRB>(leds_B, NUM_LEDS_B);
    FastLED.addLeds<WS2811, GPIO_LED_TURN, GRB>(leds_L, NUM_LEDS_turn);
...
void Signals::setBlinkerTime(int setT)
{
    blinkerPeriod = setT;
}

void Signals::setTurn(int setT)
{
    if (setT == 1)
    {
        right = false;
...
void Signals::setBrake(bool setTo)
{
    braking = setTo;
}

void Signals::setAngel(bool setTo)
{
    angel = setTo;
}

void Signals::setAngelRGB(int setR, int setG, int setB)
{
    angelRGB[0] = setR;
    angelRGB[1] = setG;
    angelRGB[2] = setB;
